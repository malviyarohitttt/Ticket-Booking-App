...
-- CreateEnum
CREATE TYPE "event_status" AS ENUM ('active', 'suspended');
...
-- AddForeignKey
ALTER TABLE "transaction" ADD CONSTRAINT "transaction_adminWalletId_fkey" FOREIGN KEY ("adminWalletId") REFERENCES "admin_wallet"("id") ON DELETE SET NULL ON UPDATE CASCADE;
